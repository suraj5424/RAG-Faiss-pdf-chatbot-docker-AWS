...
async def chat_endpoint(
    ...
    try:
        ...
        if docs:
            ...
            # Create and invoke RAG chain with improved prompt
            rag_prompt = ChatPromptTemplate.from_messages([
                ("system", """
                You are an AI assistant specialized in extracting and summarizing information from documents.
                Your task is to:
                1. Carefully analyze the retrieved context
                2. Extract all relevant information related to the user's query
                3. Provide a concise, accurate summary based on the extracted information
                4. If the user asks about specific products, specifications, or details, extract and present that information clearly
                5. Always base your answers solely on the provided context
                6. If no relevant information is found, state that clearly
